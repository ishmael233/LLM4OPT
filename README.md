...
| [Regarding Context Size in LLM-Based Metaheuristic Design](https://dl.acm.org/doi/pdf/10.1145/3712255.3734351?__cf_chl_f_tk=_eeJmKfhWsc4iyc6ezmnspc8hYKMXeK2NxIgfyHOll0-1783045116-1.0.1.1-K3M3M824Y0wBMNAUFhtaFmnDKE1Eq7MOBef8CahLsHY)| GECCO | 2025 | Iterative | Use the EASE framework to investigate how conversational context size (minimal vs. full history) affects the performance and code validity of LLM-generated metaheuristic algorithms in an iterative evolution loop, finding that fuller context improves code correctness and may aid solution quality. |
...
| [AlphaEvolve: A coding agent for scientific and algorithmic discovery](https://arxiv.org/pdf/2506.13131?)| arXiv | 2025 | Iterative | Generalize FunSearch to evolve entire code files (not just single functions) via LLM-guided island-model MAP-Elites evolution with rich contextual prompts, multi-objective optimization, and ensemble LLM sampling. |
| [HeurAgenix: Leveraging LLMs for Solving Complex Combinatorial Optimization Challenges](https://arxiv.org/pdf/2506.15196)| arXiv | 2025 | Iterative | Propose a two-stage LLM-driven hyper-heuristic framework combining contrastive heuristic evolution and adaptive online heuristic selection via LLM or dual-reward fine-tuned lightweight model with test-time search. |
...
| [AutoModSAT: Discovering Heuristics in a Complex SAT Solver with Large Language Models](https://arxiv.org/pdf/2507.22876?)| arXiv | 2025 | Iterative | Introduce a modularized SAT solver (ModSAT) with seven tunable heuristics, coupled with a presearch strategy to prune low-impact functions and unsupervised prompt optimization via entropy-based clustering. |
...
| [L-SFE: LLM-enhanced Score Function Evolution for Causal Structure Learning](https://ijcai-preprints.s3.us-west-1.amazonaws.com/2025/3512.pdf)| IJCAI | 2025 | Iterative | Use LLM to generate and evolve score function code within an EA-based bi-level optimization framework for causal structure learning, enabling automatic discovery of problem-adaptive scoring functions beyond handcrafted BIC/BDeu. |
| [EASE: Effortless Algorithmic Solution Evolution](https://arxiv.org/pdf/2509.18108?) | arXiv | 2025 | Iterative | Provide a modular framework for iterative LLM-driven solution generation, testing, analysis and refinement; demonstrated on algorithm (2048 solver) and creative tasks via closed-loop evolution. |
| [LLM-Driven Neighborhood Search for Efficient Heuristic Design](10.1109/CEC65147.2025.11043025) | CEC | 2025 | Iterative | Propose LHNS, a single-solution neighborhood search paradigm integrating Ruin-and-Recreate steps with simulated annealing acceptance. |
| [CoCoEvo: Co-Evolution of Programs and Test Cases to Enhance Code Generation](https://arxiv.org/pdf/2502.10802)| TEVC | 2025 | Iterative | Propose an LLM-based co-evolution framework that simultaneously evolves programs and test cases without pre-defined test suites, employing dynamic crossover rate scheduling and Pareto-based multi-objective test selection. |
...
| [Pareto-Grid-Guided Large Language Models for Fast and High-Quality Heuristics Design in Multi-Objective Combinatorial Optimization](https://arxiv.org/pdf/2507.20923) | arXiv | 2026 | Iterative | Propose MPaGE, a multi-objective LLM-driven heuristic generation framework that integrates the SEMO paradigm with Pareto Front Grid (PFG) to partition the objective space. |
...
| [HIFO-PROMPT: Prompting with Hindsight and Foresight for LLM-based Automatic Heuristic Design](https://arxiv.org/pdf/2508.13333)| ICLR | 2026 | Iterative | Propose a hierarchical prompting framework combining Foresight (Evolutionary Navigator for adaptive exploration-exploitation control) and Hindsight (self-evolving Insight Pool for knowledge distillation). |
| [MeLA: A metacognitive LLM-driven architecture for automatic heuristic design](https://www.sciencedirect.com/science/article/pii/S0957417426019330)| ESWA | 2026 | Iterative | Introduce Metacognitive Prompt Evolution, shifting optimization focus from heuristic code to the underlying reasoning process. |
